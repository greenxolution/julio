...
class __TwigTemplate_9bb75091c1fe4003f35f237b45e72a76 extends Template
{
    private $source;
    private $macros = [];
...
($context["root_path"] ?? null)) ? ("frontpage") : (("path-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["root_path"] ?? null), 54, $this->source))))), ((        // line 55
($context["node_type"] ?? null)) ? (("node--type-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["node_type"] ?? null), 55, $this->source)))) : ("")), ((        // line 56
($context["node_id"] ?? null)) ? (("node-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["node_id"] ?? null), 56, $this->source)))) : (""))];
  ...
  <body";
    ...
    ";
        ...
        ";
            // line 82
            $this->loadTemplate(($context["addon_template"] ?? null), "themes/gavias_castron/templates/page/html.html.twig", 82)->display($context);
            // line 83
            echo "      </div>  
    ";
        }
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["html_attributes", "placeholder_token", "head_title", "theme_path", "links_google_fonts", "customize_css", "customize_styles", "logged_in", "root_path", "node_type", "node_id", "attributes", "preloader", "page_top", "page", "page_bottom", "addon_template", "save_customize_permission"]);    }
    ...
    {
        return new Source("", "themes/gavias_castron/templates/page/html.html.twig", "/var/www/html/hbmsusa/themes/gavias_castron/templates/page/html.html.twig");
    }
